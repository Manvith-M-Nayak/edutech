  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const questionsResponse = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/questions`, {
        ...
        const submissionsResponse = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/submissions`, {
            headers: { "Authorization": `Bearer ${token}` }
        });
